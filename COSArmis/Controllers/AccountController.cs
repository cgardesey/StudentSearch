...
namespace StudentSearch.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (var con = new LdapConnection(host) { Credential = credential, AuthType = AuthType.Basic, AutoBind = false })
                    ...
                    catch
                    {
                        ...
                        {
                            //return RedirectToAction("Register", new {username = model.UserName});
                            ModelState.AddModelError("", "Please contact your administrator");
                            return View(model);
                        }
        ...
        {
            //this.UserManager.AddToRole(User.Identity.GetUserId(), "");
            return View();
        }
